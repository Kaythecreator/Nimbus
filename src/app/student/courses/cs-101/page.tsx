...
export default function CSCoursePage() {
  ...
  const upcomingTasks = [
    { task: "Complete Data Structures Assignment", due: "Today", priority: "high" },
    { task: "Study Algorithm Complexity", due: "Wednesday", priority: "medium" },
    { task: "Review OOP Concepts", due: "Friday", priority: "low" }
  ];

  const smartSuggestions = [
    "Practice more Binary Search problems - 74% accuracy",
    "Review Recursion concepts - trending topic",
    "Try advanced OOP design patterns"
  ];

  const topTopics = [
    { name: "Programming Basics", progress: 98, strength: "excellent" },
    { name: "Object-Oriented Programming", progress: 91, strength: "excellent" },
    { name: "Arrays & Lists", progress: 85, strength: "good" }
  ];

  const bottomTopics = [
    { name: "Algorithm Complexity", progress: 58, strength: "needs work" },
    { name: "Recursion", progress: 64, strength: "improving" },
    { name: "Graph Algorithms", progress: 42, strength: "needs work" }
  ];

  const badges = [
    { name: "Code Master", icon: "💻", earned: true, description: "Write 50 programs" },
    { name: "Debug Hero", icon: "🐛", earned: true, description: "Fix 25 bugs successfully" },
    { name: "Algorithm Ace", icon: "⚡", earned: false, description: "Master 10 algorithms" },
    { name: "OOP Wizard", icon: "🧙‍♂️", earned: true, description: "Complete OOP module with 90%" }
  ];
  ...
  const materials = [
    ...
    {
      id: 3,
      name: "Algorithm Complexity Guide",
      type: "PDF",
      size: "2.1 MB",
      topic: "Algorithms",
  ...
  const notes = [
    {
      ...
      content: "Step-by-step binary search algorithm with examples...",
      wordCount: 387
    },
    {
      id: 2,
      ...
      content: "Common design patterns: Singleton, Factory, Observer...",
      wordCount: 542
    }
  ];
  ...
  const flashcards = [
    {
      id: 1,
      front: "What does O(n) time complexity mean?",
      back: "The running time grows linearly with the input size n. Each additional element causes a proportional increase in processing time.",
      difficulty: "Medium"
    },
    {
      id: 2,
      front: "What is the difference between a stack and a queue?",
      back: "Stack: LIFO (Last In, First Out) - elements are added and removed from the top\nQueue: FIFO (First In, First Out) - elements are added at the rear and removed from the front",
      difficulty: "Easy"
    }
  ];
            ...
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-4 lg:px-6">
              ...
              <Tabs defaultValue="overview" className="w-full">
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-semibold">90/120 min</span>
                        </div>
                        <Progress value={75} className="h-2" />
                        <div className="flex items-center gap-2">
                          <Code className="h-4 w-4 text-green-500" />
                          <span className="text-sm">30 min to complete goal</span>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                ...
                <TabsContent value="notes" className="space-y-6">
                  <div className="flex justify-between items-center">
                    <h3 className="text-xl font-semibold">Code Notes</h3>
                    <Button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Test your CS knowledge</p>
                    ...
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Memorize key concepts</p>
                    ...
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                      <CardContent className="p-6 text-center">
                        ...
                        <h4 className="text-lg font-semibold mb-2">Coding Problems</h4>
                        <p className="text-sm text-muted-foreground mb-4">Practice programming challenges</p>
                    ...
                    <Card className="hover:shadow-lg transition-shadow cursor-pointer md:col-span-2 lg:col-span-1">
                      <CardContent className="p-6 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">Get coding help and explanations</p>
                ...
                <TabsContent value="leaderboard" className="space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="outline">Computer Science Fundamentals</Badge>
                  </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {[
                          { rank: 1, name: "David Kim", xp: 4850, level: 14, streak: 35, badge: "🏆" },
                          { rank: 2, name: "Lisa Zhang", xp: 4600, level: 13, streak: 28, badge: "🥈" },
                          { rank: 3, name: "Ryan Mitchell", xp: 4350, level: 13, streak: 22, badge: "🥉" },
                          { rank: 4, name: "Maya Patel", xp: 4100, level: 12, streak: 19, badge: "⭐" },
                          { rank: 5, name: "James Wilson", xp: 3950, level: 12, streak: 25, badge: "⭐" },
                          { rank: 6, name: "Sophie Chen", xp: 3800, level: 11, streak: 18, badge: "⭐" }
                        ].map((student) => (
                  ...
                  <Card className="border-green-200 bg-green-50">
                    <CardHeader>
                      <CardTitle className="text-green-800">Your Position</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="flex items-center justify-between p-4 bg-white rounded-lg border">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Level {courseData.level} • 8 day streak</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-lg">{courseData.xpCurrent.toLocaleString()} XP</p>
                          <p className="text-sm text-muted-foreground">Rank #7</p>
                        </div>
                      </div>
                      <div className="mt-4 text-center">
                        <p className="text-sm text-muted-foreground">
                          You need <span className="font-semibold text-green-600">600 XP</span> to reach rank #6
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div>
                          <h4 className="font-semibold mb-2">Solve 15 Algorithm Problems</h4>
                          <p className="text-sm text-muted-foreground mb-3">Complete 15 data structure and algorithm challenges to earn bonus XP</p>
                          <div className="flex items-center gap-3">
                            <Progress value={73} className="flex-1" />
                            <span className="text-sm font-medium">11/15</span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between pt-2 border-t">
                          <span className="text-sm text-muted-foreground">Ends in 4 days</span>
                          <Badge className="bg-green-100 text-green-800">+750 XP Bonus</Badge>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
